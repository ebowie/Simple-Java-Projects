...
public class Test {
	...
	public static void main(String [] args)
	{
	 ...
	 StringBuilder str= new StringBuilder("[a:Object 1,b:Object 2,]");
	 
	 for(int x=str.length()-1; x>= 0; x--)
	 {
	 
	 if(str.substring(x).equals(",")) {
	 ...
	 String myName = "[a:Object 1, b:Object 2,]";
	 char[] myNameChars = myName.toCharArray();
	 myNameChars[myName.length()-1]= ' ';
	 myNameChars[myName.length()-2] = ']';
	
	 myName = String .valueOf(myNameChars);
	 myName = myName.trim();
	 System.out.println(myName.substring(myName.length()-1));
